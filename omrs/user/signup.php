...
<html lang="en">
  <head>
    ...
    <title>MARRIAGE REGITRATION e-PORTAL OF INDIA||Sign Up page</title>
    ...
    <div class="am-signin-wrapper">
      <div class="am-signin-box">
        <div class="row no-gutters">
          <div class="col-lg-5">
            <div>
              <h2>MARRIAGE REGISTRATION e-PORTAL OF INDIA</h2>
              <p>New Resgistration for user</p>
...
<div class="form-group">
        ...
        <p class="tx-center tx-white-5 tx-12 mg-t-15"> &copy; MARRIAGE REGISTRATION e-PORTAL OF INDIA</p>
      </div><!-- signin-box -->
