...
<html lang="en">
  <head>
    ...
    <title>MARRIAGE REGITRATION E-PORTAL OF INDIA||Sign in page</title>
    ...
    <div class="am-signin-wrapper">
      <div class="am-signin-box">
        <div class="row no-gutters">
          <div class="col-lg-5">
            <div>
              <h3>MARRIAGE REGISTRATION e-PORTAL OF INDIA</h3>
              <h5>Welcome to User panel </h5>
              <p></p>
...
<div class="form-group mg-b-0" style="padding-top: 0px"><a href="forgot-password.php">Reset password</a></div>
        ...
        <p class="tx-center tx-white-5 tx-12 mg-t-15">© MARRIAGE REGISTRATION E-PORTAL OF INDIA,2022</p>
      </div><!-- signin-box -->
